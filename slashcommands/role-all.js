...
module.exports = {
    ...
    options: [
        {
          type: "role",
          name: "role",
          description: "Rôle à donenr aux membres du serveur.",
          required: true,
          autocomplete: false,
        },
      ],
    async run(bot, message, args) {
      ...
      const em = new EmbedBuilder()
          .setAuthor({ name: 'Attribution en masse de rôle', url: "https://discord.gg/WzQGA8A5", iconURL: bot.user.displayAvatarURL({ dynamic: true })})
          ...
          **Que souhaitez-vous faire ?**
          ...
          const menumsg = await message.reply({embeds:[em], components: [row3], fetchReply: true })
