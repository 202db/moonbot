...
module.exports = {
    ...
    options: [
        {
          type: "user",
          name: "user",
          description: "Utilisateur dont vous voulez obtenir des informations.",
          required: false,
          autocomplete: false,
        },
      ],
    ...
    let embed
    let user = args.getUser("user") || message.guild.members.cache.get(message.user.id)
    ...
    embed = new Discord.EmbedBuilder()
        ...
        .setColor("White")
        .setAuthor({ name: `Informations sur l'utilisateur`, url: "https://discord.gg/WzQGA8A5", iconURL: bot.user.displayAvatarURL({ dynamic: true }) })
